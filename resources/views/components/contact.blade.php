...
<div class="flex justify-center pt-2 mt-12 ">
    <div class="flex-initial  border-3 border-black bg-gray-200 px-10 py-4 text-center rounded-3xl ">
        <div class="pb-12">
        <h1 class="text-4xl">Contacteer ons</h1>
        <h3 class="text-1xl text-gray-500">Ik hoop snel te kunnen reageren!</h3>
        </div>
        <form class="grid  gap-6 ">
            ...
            <div class="my-3.5 pb-5">
                <button class="text-white bg-green-500  mt-5 w-full h-full dark:hover:bg-green-700 font-medium rounded-lg">Verstuuren</button>
            </div>
        </form>
    </div>
</div>
