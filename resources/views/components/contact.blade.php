...
<div class="flex justify-center pt-2 mt-12 ">
    <div class="flex-initial gradientBg  border-3 border-black bg-gray-200 px-10 py-4 text-center rounded-3xl ">
        <div class="pb-12">
        <h1 class="text-4xl">Contacteer ons</h1>
        <h3 class="text-1xl text-white">Ik hoop snel te kunnen reageren!</h3>
        </div>
