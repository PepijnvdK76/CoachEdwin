<script>
    window.onscroll = function () {
        ...
        const header_btns = document.querySelector(".test");
        const sticky = header_navbar.offsetTop;

        if (window.pageYOffset > sticky) {
            header_navbar.classList.add("sticky");
            header_btns.classList.add("sticky");
        } else {
            header_navbar.classList.remove("sticky");
            header_btns.classList.remove("sticky");
        }
    };
</script>
<div class="wrapper">
    <div id="global-navigation">
        <!-- Global Header -->
        <nav class="navbar-area absolute top-0  left-0 z-50  w-full text-white  px-5 sm:px-4 py-2.5 bg-gray-900 border-b border-gray-200 dark:border-gray-600">
            <div class="container flex flex-wrap justify-between items-center mx-auto">
                <a href="https://flowbite.com/" class="flex items-center">
                    <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo">
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Coach Edwin</span>
                </a>
                <div class="flex md:order-2">
                    <button type="button" class="text-white bg-green-500 dark:hover:bg-green-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 ">Get started</button>
                ...
                <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1 test" id="navbar-sticky">
